...
# @params
# 
# alluv_cols         A vector of sequence labels to consider.
#                    E.g. timepoint-compartment combinations.
# df_clone_info      A data.frame containing summary info of clones.
#                    This is expected to have been generated by 
#                    `summarize_clone`.
# col_df_clone_id    Column name in `df_clone_info` containing clone IDs.
# vec_overlap_regex  Optional. A vector containing regex patterns 
...
#
# @param
# lst_pairs         A list containing vector(s) of length 2.
#                   Eg: `list(c("PB_d28, "GC_d28"), c("PB_d28", "GC_d35"))`
# alluv_cols        A vector of sequence labels. 
#                   Same the input for `prep_for_alluv`.
# alluv_df          A data.frame outputted by `prep_for_alluv`.
# alluv_lst_cl_id   A list outputted by `prep_for_alluv`.
# df_data           A data.frame containing sequence data.
# col_df_clone_id   Column name `df_data` containing clone IDs.
# col_df_mf         Column name `df_data` containing SHM frequency.
# col_df_label      Column name `df_data` containing the labels in `alluv_cols`.
# 
# @returns
...
# 
# @params
# vec_facets      Vector outputted by `prep_for_paired_mf`
# pairs_df_wide   Wide-format data.frame outputted by `prep_for_paired_mf`
# p_adj_method    Method for p-value adjustment. Passed to `p.adjust`.
# 
# @returns
